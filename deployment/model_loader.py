...
class ModelLoader:
    """
    This class will load the Preprocessor and the model that will be used
    to predict
    Args:
    ...
    def __init__(self, is_test_service):
        ...
        if not is_test_service:
            ...
            self.model_name = os.getenv("MODEL_NAME", "crab-age-predictor")
    ...
    def load_dv(self, run_id, artifact_path="artifact/preprocessor.b", is_test_service=False):
